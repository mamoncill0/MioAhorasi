...
#17 🔄 Conversor de unidades avanzado
...
km = int(input("Pon un numero en kilometros "))
metros = km * 1000
centimetros = km * 100000
milimetros = km * 1000000
print("Kilometros: ", km, "metros", metros, "centimetros", centimetros, "milimetros", milimetros)
"""